    ...
    companion object {
        fun getQuizQuestions(): MutableList<Quiz> {
            return mutableListOf(
                ...
                Quiz(
                    2,
                    "What is the purpose of the 'is' operator in Kotlin?",
                    IS_CHECK_BOX,
                    ...
                    "a",
                    null,
                    mutableListOf("Type checking","Data class", "Loop statement", "Handling exceptions")
                ),
                Quiz(
                    3,
                    "How does Kotlin differ from Java in terms of syntax and usage?",
                    IS_RADIO_BUTTON,
                ...
                Quiz(
                    4,
                    "What are some of the key benefits of using Kotlin for Android development?",
                    IS_CHECK_BOX,
                ...
                Quiz(
                    8,
                    "What is the purpose of the Any class in Kotlin?",
                    IS_RADIO_BUTTON,
                ...
                Quiz(
                    9,
                    "What is the purpose of the 'break' and 'continue' keywords in Kotlin?",
                    IS_RADIO_BUTTON,
                ...
                Quiz(
                    10,
                    "What are some of the common ways to create a new instance of a class in Kotlin?",
                    IS_CHECK_BOX,
                ...
                Quiz(
                    12,
                    "What is the purpose of the 'lambda' in kotlin?",
                    IS_RADIO_BUTTON,
                ...
                Quiz(
                    ...
                    "c",
                    null,
                    mutableListOf("Data storage vs behavior","No difference", "Automatic generation of methods", "None of the above")
                ),
                Quiz(
                    14,
                ...
                Quiz(
                    15,
                    "What is the purpose of the 'try-catch' block in Kotlin?",
                    IS_CHECK_BOX,
